# Bem-vindo ao laPadocca
Projeto desenvolvido na faculdade para aplicação dos conhecimentos obtidos no segundo ano letivo.

### O projeto se trata de um sistema para gerencimaneto de um comercio (padaria) onde conforme imagens abaixo foram criados alguns CRUD's, arquitetura REST e AJAX.
### Para a autenticação do usuário é utilizado o método de conversão para base64 e posteriormente para o padrão MD5.
### O projeto possui alguns niveis de permissionamento (Administrador, Vendedor, Fabricante).
